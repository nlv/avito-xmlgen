...
var $author$project$App$initModel = {count: 0, text: ''};
...
var $author$project$App$downloadFile = function (fileContent) {
	return A3($elm$file$File$Download$bytes, 'result.xlsx', 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', fileContent);
};
var $elm$core$Basics$neq = _Utils_notEqual;
var $author$project$App$FormUploaded = function (a) {
	return {$: 'FormUploaded', a: a};
};
...
var $author$project$App$resolve = F2(
...
var $author$project$App$sendRequest = F2(
	function (count, text) {
		return $elm$http$Http$post(
			{
				...
				expect: A2(
					...
					$author$project$App$FormUploaded,
					$author$project$App$resolve($elm$core$Result$Ok)),
				url: 'api/'
			});
	});
			...
			case 'TextInput':
				...
				return _Utils_Tuple2(
					_Utils_update(
						...
						{text: text}),
					$elm$core$Platform$Cmd$none);
			case 'SendRequestButtonPressed':
				return (model.text !== '') ? _Utils_Tuple2(
					model,
					A2($author$project$App$sendRequest, model.count, model.text)) : _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			case 'DisabledSendRequestButtonPressed':
				return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			default:
				if (action.a.$ === 'Ok') {
					var response = action.a.a;
					return _Utils_Tuple2(
						model,
						$author$project$App$downloadFile(response));
				} else {
					var err = action.a.a;
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
...
var $author$project$App$CountInput = function (a) {
	return {$: 'CountInput', a: a};
};
...
var $author$project$App$lableStyle = _List_fromArray(
	[
...
var $author$project$App$rowStyle = _List_fromArray(
	[
...
var $author$project$App$countInput = function (count) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		$author$project$App$rowStyle,
		_List_fromArray(
			[
				A2(
				...
				_List_Nil,
				{
					label: A2(
						...
						A2(
							$mdgriffith$elm_ui$Element$el,
							$author$project$App$lableStyle,
							$mdgriffith$elm_ui$Element$text('Количество вариантов:'))),
					onChange: $author$project$App$CountInput,
					placeholder: $elm$core$Maybe$Nothing,
					text: $elm$core$String$fromInt(count)
				})
			]));
};
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$App$DisabledSendRequestButtonPressed = {$: 'DisabledSendRequestButtonPressed'};
var $author$project$App$SendRequestButtonPressed = {$: 'SendRequestButtonPressed'};
...
var $author$project$App$buttonStyle = _List_fromArray(
	[
...
var $author$project$App$sendRequestButton = function (ready) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		$author$project$App$rowStyle,
		_List_fromArray(
			[
				...
				A2(
					$elm$core$List$cons,
					$mdgriffith$elm_ui$Element$Background$color(
						A3($mdgriffith$elm_ui$Element$rgb, 220, 220, 220)),
					A2(
						$elm$core$List$cons,
						$mdgriffith$elm_ui$Element$Region$description('Укажите текст'),
						$author$project$App$buttonStyle)),
				{
					label: $mdgriffith$elm_ui$Element$text('Рандомизировать'),
					onPress: $elm$core$Maybe$Just($author$project$App$DisabledSendRequestButtonPressed)
				})
			]));
};
var $author$project$App$TextInput = function (a) {
...
var $author$project$App$textInput = function (text) {
	return A2(
		$mdgriffith$elm_ui$Element$row,
		$author$project$App$rowStyle,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$width(
						A2($mdgriffith$elm_ui$Element$minimum, 1100, $mdgriffith$elm_ui$Element$fill))
					]),
				{
					label: A2(
						$mdgriffith$elm_ui$Element$Input$labelLeft,
						...
						A2(
							$mdgriffith$elm_ui$Element$el,
							$author$project$App$lableStyle,
							$mdgriffith$elm_ui$Element$text('Текст для рандомизации:'))),
					onChange: $author$project$App$TextInput,
					placeholder: $elm$core$Maybe$Nothing,
					spellcheck: false,
					text: text
				})
...
var $author$project$App$view = function (model) {
	return A2(
		...
		A2(
			...
			_List_fromArray(
				[
					$author$project$App$countInput(model.count),
					$author$project$App$textInput(model.text),
					$author$project$App$sendRequestButton(model.text !== '')
				])));
};
var $author$project$App$main = $elm$browser$Browser$element(
	{
		init: function (_v0) {
			return _Utils_Tuple2($author$project$App$initModel, $elm$core$Platform$Cmd$none);
		},
